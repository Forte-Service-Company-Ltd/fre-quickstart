...
![Screenshot showing how to copy repo as a template](https://github.com/Forte-Service-Company-Ltd/fre-quickstart/blob/main/image/use-template-gh.jpg?raw=true)
...
For a detailed explanation of why this override is required and how to set the Calling Contract Admin, see [Step 10: Set your address as the Calling Contract Admin](#8-set-your-address-as-the-calling-contract-admin).
